...
api.changeNickname(`${(!global.config.BOTNAME) ? "Made by O M A R" : global.config.BOTNAME}`, handleReply.pending[singleIndex - 1].threadID, api.getCurrentUserID());
            api.sendMessage("", event.threadID, () => api.sendMessage({body:`الاسطورة سيستا معكم ✅✨`, attachment: fs.createReadStream(__dirname + "/../../kur.mp4")} ,handleReply.pending[singleIndex - 1].threadID));
            count+=1;
